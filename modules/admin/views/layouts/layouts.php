               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item active">
                        <a class="nav-link" href="<?=url::to(['slider/index'])?>">Home</a>
                     </li>
                     <li class="nav-item ">
                        <a class="nav-link" href="<?=url::to(['services/index'])?>">Services</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['meet/index'])?>">Meets</a>
                     </li>
                    
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['price/index'])?>">Pricing</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['news/index'])?>">Blog</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['message/index'])?>">Contact</a>
                     </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['call/index'])?>">Call</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['project-category/index'])?>">Categoriya</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['project-img/index'])?>">Rasmlar</a>
                     </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['section/index'])?>">Section</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?=url::to(['../busenes/logout'])?>">Chiqish</a>
                     </li>
                  </ul>
               </div>
            </div>
